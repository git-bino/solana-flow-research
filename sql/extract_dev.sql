-- Phase 0 extract — dev chunk 01.  Executed query, verbatim.
--
...
--
--   launch window  [2026-05-10 00:00, 2026-05-19 00:00)   9 days
--   event window   [2026-05-10 00:00, 2026-08-15 23:59)  97 days
...
-- launch filter ends 2026-05-19, 54 days before the holdout opens.  The `guard`
...
guard AS (
    SELECT if(max(created_at) >= TIMESTAMP '2026-05-19 00:00:00'
              OR min(created_at) < TIMESTAMP '2026-05-10 00:00:00',
              CAST(fail('LAUNCH WINDOW GUARD: a token outside [2026-05-10, 2026-05-19)'
