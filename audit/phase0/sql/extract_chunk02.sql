-- Phase 0 extract — dev chunk 02.  Executed query, verbatim.
...
--
--   launch window  [2026-05-19 00:00, 2026-05-28 00:00)   9 days
--   event window   [2026-05-19 00:00, 2026-08-15 23:59)  88 days
...
-- launch filter ends 2026-05-28, 45 days before the holdout opens.  The `guard`
...
guard AS (
    SELECT if(max(created_at) >= TIMESTAMP '2026-05-28 00:00:00'
              OR min(created_at) < TIMESTAMP '2026-05-19 00:00:00',
              CAST(fail('LAUNCH WINDOW GUARD: a token outside [2026-05-19, 2026-05-28)'
