-- Phase 0 extract — dev chunk 06.  Executed query, verbatim.
...
--
--   launch window  [2026-06-24 00:00, 2026-07-03 00:00)   9 days
--   event window   [2026-06-24 00:00, 2026-08-15 23:59)  53 days
...
-- launch filter ends 2026-07-03, 9 days before the holdout opens.  The `guard`
...
WITH sel AS (
    ...
    WHERE evt_block_date >= DATE '2026-06-24'
...
guard AS (
    SELECT if(max(created_at) >= TIMESTAMP '2026-07-03 00:00:00'
              OR min(created_at) < TIMESTAMP '2026-06-24 00:00:00',
              CAST(fail('LAUNCH WINDOW GUARD: a token outside [2026-06-24, 2026-07-03)'
...
ev AS (
    ...
    WHERE t.evt_block_date >= DATE '2026-06-24'
